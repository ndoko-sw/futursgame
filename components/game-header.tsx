...
const BNAV = [
  ...
  { href: '/brand', fr: 'Ma Marque', en: 'My Brand', session: true, icon: <svg viewBox="0 0 22 22" fill="none" strokeWidth="1.4" stroke="currentColor"><path d="M4 4 H11 L18.5 11.5 L11 19 L3.5 11.5 Z"/><circle cx="8" cy="8" r="1.4"/></svg> },
  { href: '/portfolio', fr: 'Portfolio', en: 'Portfolio', session: true, icon: <svg viewBox="0 0 22 22" fill="none" strokeWidth="1.4" stroke="currentColor"><rect x="3.5" y="3.5" width="6.5" height="6.5"/><rect x="12" y="3.5" width="6.5" height="6.5"/><rect x="3.5" y="12" width="6.5" height="6.5"/><rect x="12" y="12" width="6.5" height="6.5"/></svg> },
